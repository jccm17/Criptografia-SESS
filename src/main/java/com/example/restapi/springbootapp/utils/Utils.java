...
public class Utils {
     ...
     * @param shortLen
     */
    protected static void squashBytesToShortsLittle(byte[] inBytes, int inOff, int[] outShorts, int outOff,
            int shortLen) {
        for (int i = 0; i < shortLen; ++i) {
     ...
     * @param shortLen
     */
    protected static void spreadShortsToBytesLittle(int[] inShorts, int inOff, byte[] outBytes, int outOff,
            int shortLen) {
        for (int i = 0; i < shortLen; ++i) {
