 ...
 * <p>
 * The file format is compatible with that of IDEA V1.1 (IDEA_CMD.C, ETH
 * version).
 * The length of the plaintext data file is appended to the encrypted file in an
 * 8 byte suffix.
 */
public class EncriptadorIDEAFiles {
     ...
     * <p>
     * See <a href=
     * "https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">Wikipedia</a>.
     * <p>
     * The current implementation only supports ECB and CBC1.
     */
    public enum Mode {
        ECB, CBC1
    };
     ...
     * @param charKey
     *                       The encryption key. A string of ASCII characters within
     *                       the range 0x21 .. 0x7E.
     * @param encrypt
     ...
     *                       Mode of operation.
     */
    public void cryptFile(String inputFileName, String outputFileName, String charKey, boolean encrypt,
        ...
        try {
            ...
            outChannel = FileChannel.open(Paths.get(outputFileName), StandardOpenOption.CREATE,
    ...
    private static void pumpData(FileChannel inChannel, long inDataLen, FileChannel outChannel, long outDataLen,
            BlockStreamCrypter bsc) throws IOException {
    ...
    private static void writeDataLength(FileChannel channel, long dataLength, BlockStreamCrypter bsc)
            throws IOException {
    ...
    // To support larger files, we allow 13 more bits than the original IDEA V1.1
    // implementation.
    // But files larger than 4GB are no longer backward compatible with the old IDEA
    // V1.1 file structure.
    ...
    // Returns -1 if the encoded value is invalid. This means that the input file is
    // not a valid cryptogram.
