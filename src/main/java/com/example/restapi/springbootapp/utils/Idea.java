 ...
 * <p>
 * See <a href=
 * "https://en.wikipedia.org/wiki/International_Data_Encryption_Algorithm">Wikipedia</a>.
 */
public class Idea {
    ...
    /**
     * Creates an instance of the IDEA processor, initialized with a 16-byte binary
     * key.
     *
     * @param key
    ...
    /**
     * Creates an instance of the IDEA processor, initialized with a character
     * string key.
     *
     * @param charKey
